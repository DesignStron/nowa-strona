      ...
      <div className="container mx-auto max-w-3xl px-4 py-20">
        ...
        >
          <Section title="1. Co to są cookies?">
            <p>
              Cookies to małe pliki tekstowe przechowywane na Twoim urządzeniu. Są
              używane do zapamiętywania informacji o Tobie i Twoich preferencjach.
            </p>
          </Section>

          <Section title="2. Jakie cookies używamy?">
            <p>Używamy następujących typów cookies:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Cookies niezbędne:</strong> Wymagane do funkcjonowania strony
              </li>
              <li>
                <strong>Cookies analityczne:</strong> Pomagają nam zrozumieć, jak
                korzystasz ze strony (Google Analytics)
              </li>
              <li>
                <strong>Cookies marketingowe:</strong> Używane do personalizacji reklam
              </li>
            </ul>
          </Section>

          <Section title="3. Jak kontrolować cookies?">
            <p>Możesz kontrolować cookies poprzez:</p>
            <ul className="list-disc pl-6 space-y-2">
              <li>Ustawienia przeglądarki</li>
              <li>Nasz banner cookies na stronie głównej</li>
              <li>Narzędzia do zarządzania prywatnością</li>
            </ul>
          </Section>

          <Section title="4. Cookies stron trzecich">
            <p>
              Nasza strona może zawierać linki do stron trzecich, które mogą
              umieszczać własne cookies. Nie mamy kontroli nad tymi cookies.
            </p>
          </Section>

          <Section title="5. Czas przechowywania">
            <p>
              Cookies są przechowywane przez okres niezbędny do ich funkcji, zwykle
              od kilku dni do roku.
            </p>
          </Section>

          <Section title="6. Twoje prawa">
            <p>
              Masz prawo do usunięcia cookies i odmowy ich akceptacji. Może to
          ...
          <Section title="7. Kontakt">
            <p>
              W przypadku pytań dotyczących cookies, skontaktuj się z nami:
            </p>
            <ul className="list-disc pl-6 space-y-2">
